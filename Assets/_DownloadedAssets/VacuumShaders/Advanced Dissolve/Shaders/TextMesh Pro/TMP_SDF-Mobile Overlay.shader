...
#include "../cginc/AdvancedDissolve.cginc"
...
#else
			float4 alpha = ReadDissolveAlpha(input.texcoord0.xy, input.dissolveUV, input.worldPos);
#endif				
		...
		float dissolveBlend = DoDissolveAlbedoEmission(alpha, dissolveAlbedo, dissolveEmission, input.texcoord0.xy);
