...
#include "../../cginc/Integration_CurvedWorld.cginc"
...
#else
			float4 dAlpha = ReadDissolveAlpha(IN.uv.xy, IN.dissolveUV, IN.worldPos);
#endif
		...
		float dissolveBlend = DoDissolveAlbedoEmission(dAlpha, dissolveAlbedo, dissolveEmission, IN.uv.xy);
