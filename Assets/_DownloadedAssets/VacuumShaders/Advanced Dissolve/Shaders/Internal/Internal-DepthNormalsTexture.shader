...
#else
			DissolveVertex2Fragment(o.pos, v.texcoord, v.texcoord1, o.dissolveUV);
#endif
...
#else
			float4 alpha = ReadDissolveAlpha(i.uv, i.dissolveUV, i.worldPos);
#endif
...
#pragma shader_feature _ _DISSOLVEMASKCOUNT_TWO _DISSOLVEMASKCOUNT_THREE _DISSOLVEMASKCOUNT_FOUR
		...
		#ifdef _DISSOLVEMAPPINGTYPE_TRIPLANAR
			float4 dAlpha = ReadDissolveAlpha_Triplanar(i.coords, i.objNormal, i.worldPos);
		#else
			float4 dAlpha = ReadDissolveAlpha(i.uv.xy, i.dissolveUV, i.worldPos);
		#endif
