...
#else
				DissolveVertex2Fragment(o.vertex, v.uv0, v.uv1, o.dissolveUV);
#endif
...
#else
				float4 alpha = ReadDissolveAlpha(i.uv0.xy, i.dissolveUV, i.worldPos);
#endif				
...
float3 dissolveEmission = 0;
				float dissolveBlend = DoDissolveAlbedoEmission(alpha, dissolveAlbedo, dissolveEmission, i.uv0);
...
#define _DISSOLVEMASKCOUNT_FOUR
