...
#else
	DissolveVertex2Fragment(o.pos, v.texcoords, v.texcoords1.xy, o.dissolveUV);
#endif
...
#else
float4 alpha = ReadDissolveAlpha(IN.custompack0.xy, IN.dissolveUV, IN.worldPos);
#endif
...
float dissolveBlend = DoDissolveAlbedoEmission(alpha, dissolveAlbedo, dissolveEmission, IN.custompack0.xy);
...
#LINE 106
  ...
  Fallback "VacuumShaders/Advanced Dissolve/VertexLit" 
	CustomEditor "AdvancedDissolveStandardParticlesShaderGUI"
}
