...
#else
				DissolveVertex2Fragment(o.vertex, v.texcoords.xy, v.texcoordBlend.xy, o.dissolveUV);
#endif
...
#else
				float4 alpha = ReadDissolveAlpha(i.texcoord.xy, i.dissolveUV, i.worldPos);
#endif				
...
float3 dissolveEmission = 0;
			float dissolveBlend = DoDissolveAlbedoEmission(alpha, dissolveAlbedo, dissolveEmission, i.texcoord.xy);
